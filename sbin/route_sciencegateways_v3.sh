...
### BEGIN INIT INFO
# Provides:          route_sciencegateways_v3
# Required-Start:    $remote_fs $syslog
# Required-Stop:     $remote_fs $syslog
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: Route ScienceGateways information from a source to a destination
# Description:       Route ScienceGateways information from a {file, directory, amqp} to a {directory, api}
### END INIT INFO

####### Customizations START #######
APP_NAME=route_sciencegateways_v3
APP_BASE=/soft/warehouse-apps-1.0/Manage-ScienceGateways-V3
